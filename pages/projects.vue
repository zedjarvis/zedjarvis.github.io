          ...
          <td class="py-4 pr-4 align-top font-semibold leading-snug text-slate-200">
            <div>
              <div class="block sm:hidden"><a
                  ...
                  href="https://toolkit.michelleforboston.com/" target="_blank" rel="noreferrer"
                  aria-label="Michelle Wu for Boston Grassroots Toolkit"><span>Michelle Wu for Boston Grassroots<!-- -->
                    <span class="inline-block">Toolkit<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                        fill="currentColor"
              ...
              <div class="hidden sm:block">Michelle Wu for Boston Grassroots Toolkit</div>
            </div>
          </td>
          ...
          <td class="hidden py-4 align-top sm:table-cell">
            <ul class="translate-y-1">
              <li class="mb-1 flex items-center">
                <a class="inline-flex items-baseline font-medium leading-tight text-sm text-slate-400 hover:text-slate-200 focus-visible:text-teal-300 group/link"
                  href="https://toolkit.michelleforboston.com/" target="_blank" rel="noreferrer"
                  aria-label="toolkit.michelleforboston.com"><span> <span
                      class="inline-block">toolkit.michelleforboston.com<svg xmlns="http://www.w3.org/2000/svg"
