...
await navigateTo("https://cedrouseroll.vercel.app", {
  external: true, // Required for external URLs
  redirectCode: 302, // Optional: specify HTTP status code (default is 302)
});
